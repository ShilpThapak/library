...
export const resolvers = {
    ...
    Mutation: {
        ...
        addAuthor: async (_, args) => {
            ...
            const savedAuthor = await Author.findByPk(newAuthor.id);

            console.log(savedAuthor, "______"); // ✅ Ensure full data is retrieved
            console.log(newAuthor, typeof(newAuthor))
            return newAuthor
        },
